...
2. Predicted sentences from an automatic sentence segmentation tool, such as Punkt<d-cite key="punkt"></d-cite>. Many of these are trained on ground-truth sentences.
